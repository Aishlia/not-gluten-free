...
for (i = 0; i < shapes.length; i++) {
    ...
    //draggableSVG = new DraggableSVG({"fill": "black"}, document.getElementById("drag-container"), shapes[0])
    ...
    console.log("width",s.vertices[1].x-s.vertices[0].x);
...
*/
    ...
    console.log(s.pos.x, s.pos.y);
    // invis_shapes[i] = new DraggableSVG({"fill": "black",
    //                                  "width": shapes[i].vertices[1].x-shapes[i].vertices[0].x,
    //                                  "height": shapes[i].vertices[3].y-shapes[i].vertices[0].y,
    //                                  "x": s.pos.x,
    //                                  "y": s.pos.y},
...
shape.enter().append('g')
    ...
    .each(function(s) {
        ...
        node.enter().append("circle")
            ...
            // draggableShape = new DraggableSVG({}, d3.select(this)[0][0],
            //   document.getElementById("drag-container"))
...
function animate() {
    ...
    for (i = 0; i < shapes.length; i++) {
        ...
        s.setAngle(
            ...
            // Math.floor((s.angle + s.rot_p / s.I * dt)/ 16)
